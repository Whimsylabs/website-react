...
export default {
  ...
  welcomeText:
    "WhimsyLabs proporciona software de laboratorio virtual galardonado que da a educadores y estudiantes la libertad de explorar, jugar y aprender conceptos científicos de primera mano. Ya sea que estés enseñando Biología, Química o Física, nuestras simulaciones de laboratorio en línea permiten a los estudiantes experimentar con fenómenos científicos y equipos sin las limitaciones y riesgos de un laboratorio físico. Nuestros laboratorios virtuales STEM para escuelas ayudan a los estudiantes a desarrollar habilidades de laboratorio de manera segura mientras proporcionan a los educadores herramientas de evaluación poderosas.",
