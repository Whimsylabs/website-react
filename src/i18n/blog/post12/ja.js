...
export const content = (
  <div>
    <p>
      ...
      ）。問題は何でしょうか？従来の教育は、学生に実験室で何をすべきかを教えますが、プロの科学が要求する物理的な実技スキル、手順の流暢さ、実験デザイン能力を育成することができません。WhimsyLabsは、高精度なVR相互作用を通じて本物の物理的動作を教え、実験デザインのための完全な探究学習の自由を提供することで、この重要なギャップに対処する世界で唯一のシミュレーション教材プラットフォームです。これらの技術は、プロのSTEMキャリアに直接転用できます。
    </p>
    ...
    <p>
      WhimsyLabsは根本的に異なります。私たちは、学生がVRで実験室の手順を物理的に実行することを要求する唯一のプラットフォームであり、物理的な実験室に直接転用できる確かな実技スキルと手順の流暢さを育成します。私たちの独自のアプローチには以下が含まれます。
    </p>

    <h3>本物の物理的動作と実技スキルの習得</h3>
    ...
    <p>
      ...
      ）。WhimsyLabsを使用する学生は、物理的な実験練習と同じ実技スキル、手と目の協調、手順の自動化を育成します。これは、従来のシミュレーション教材プラットフォームでは不可能な予習と復習です。
    </p>
