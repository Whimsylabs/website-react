// French - Post 10: Intelligence émotionnelle dans les tuteurs IA
import React from "react";

export const title = "Intelligence émotionnelle dans les tuteurs IA : Comment WhimsyCat détecte et répond à la frustration des étudiants";
export const description = "Exploration du système révolutionnaire de détection de frustration de WhimsyCat qui surveille les actions des joueurs, le suivi du regard et les modèles d'engagement pour fournir un soutien émotionnel proactif lorsque les étudiants rencontrent des difficultés.";
...
export const content = (
  <div>
    <p>
      La recherche montre que les émotions négatives comme la frustration sont fortement corrélées négativement avec la performance académique, les étudiants frustrés connaissant des résultats d'apprentissage nettement moins bons (
      <a
    ...
    <h2>Pourquoi la détection de frustration est-elle essentielle pour l'apprentissage ?</h2>
    ...
    <p>
      Les systèmes d'IA capables de détecter la frustration en temps réel offrent un potentiel transformateur. Une méta-analyse complète de 54 études publiées jusqu'en 2025 a révélé que les interventions d'IA émotionnelle qui détectent et régulent l'anxiété, l'ennui ou la frustration peuvent stabiliser les émotions de réussite et améliorer les résultats d'apprentissage (
      <a
        href="https://link.springer.com/article/10.1007/s10648-025-10086-4"
        target="_blank"
        rel="noopener noreferrer"
      ...
      ). WhimsyCat incarne la pointe de cette recherche, mettant en œuvre une détection de frustration multimodale sophistiquée qui identifie les étudiants en difficulté et intervient avec un soutien calibré avec précision.
    </p>
    ...
    <h3>Surveillance des actions du joueur</h3>
    ...
    <ul>
      <li>
        <a href="/blog/whimsycat-ai-tutor-transforming-science-education">
          Découvrez WhimsyCat : Le tuteur IA émotionnellement intelligent
        </a>
      </li>
      <li>
      ...
      <li>
        <a href="/blog/virtual-kidney-dissection-send-engagement">
          Dissection virtuelle de rein : Soutenir des besoins d'apprentissage divers
        </a>
      </li>
    </ul>
