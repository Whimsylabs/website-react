...
export const content = (
  <div>
    ...
    <p>
      En el corazón de la filosofía sandbox de WhimsyLabs está un principio
      simple pero poderoso: el fracaso es el mayor maestro. Nuestro laboratorio
      virtual está específicamente diseñado para permitir a los estudiantes
      cometer errores y presenciar consecuencias realistas; desde errores
      procedimentales menores hasta explosiones (virtuales) dramáticas. Cada
      fracaso se convierte en una oportunidad de aprendizaje valiosa,
      proporcionando retroalimentación inmediata y experiencial que refuerza
      técnicas correctas y profundiza la comprensión conceptual.
    </p>
    ...
    <img
      ...
      alt="¡Un estudiante hirviendo etanol, muy peligroso!"
    ...
    <p>
      ...
      sandbox de WhimsyLabs refleja más precisamente cómo trabajan los
      científicos reales; formando hipótesis, diseñando experimentos para
    ...
    <ul>
      <li>
        <strong>Exploración Abierta:</strong> Los estudiantes pueden combinar
        equipo, químicos y técnicas de miles de maneras diferentes, fomentando
        resolución creativa de problemas y pruebas de hipótesis.
      </li>
      <li>
      ...
      <li>
        ...
        lógicos y físicamente precisos basados en nuestro motor de simulación
        avanzado, reforzando la comprensión causa-efecto.
      </li>
      <li>
        <strong>Refinamiento Iterativo:</strong> Los estudiantes pueden repetir
        rápidamente experimentos con modificaciones, fomentando el proceso
        científico de mejora continua.
      </li>
    </ul>

    <p>
      La investigación en aprendizaje basado en investigación científica
      demuestra que la exploración abierta y las pruebas de hipótesis son
      fundamentales para desarrollar habilidades de pensamiento científico
      auténticas. Un meta-análisis de enseñanza científica basada en
      investigación encontró que los estudiantes involucrados en aprendizaje
      genuino basado en investigación demostraron habilidades de razonamiento
      científico más fuertes y mayor comprensión conceptual comparado con
      aquellos siguiendo procedimientos de laboratorio prescritos (
      <a
    ...
    <h3>Enfoques Diversos, Aprendices Diversos</h3>
    ...
    <p>
      "Regularmente vemos estudiantes tomar enfoques radicalmente diferentes
    ...
    <h3>Equilibrando Libertad con Orientación</h3>

    <p>
      Mientras que WhimsyLabs aboga fuertemente por la libertad experimental,
      reconocemos que el aprendizaje efectivo requiere andamiaje y orientación
      apropiados. Nuestra plataforma logra un equilibrio cuidadoso entre
      exploración abierta y soporte estructurado a través de varias
    ...
    <p>
      Este aprendizaje sandbox se amplifica por nuestra{" "}
