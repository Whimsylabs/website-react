...
export const title = "OCDE: Evalúa el proceso, no el producto, en ciencias";
export const description = "El OECD Digital Education Outlook 2026 recomienda oficialmente la 'evaluación orientada al proceso' para la era de la IA. Esta validación internacional confirma lo que WhimsyLabs ha construido desde el principio.";
...
export const content = (
  <>
    ...
    <p>
      La preocupación no es hipotética. RTE informó sobre la advertencia de la OCDE de que "si se usa como atajo en lugar de herramienta de aprendizaje, la IA puede desplazar el esfuerzo cognitivo y debilitar las habilidades que sustentan el aprendizaje profundo." El informe advierte explícitamente contra "el espejismo de la falsa maestría, donde los impresionantes resultados generados por la IA enmascaran el subdesarrollo de habilidades esenciales" (
      <a
    ...
    <h2>¿Por qué la evaluación tradicional no puede adaptarse?</h2>
    ...
    <h2>Por qué los laboratorios de ciencias son el caso de estudio perfecto</h2>
    ...
    <h2>Implicaciones para escuelas y profesores</h2>
    ...
    <h2>El desafío de la implementación</h2>
