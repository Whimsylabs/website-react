...
export const title = "OCDE : évaluer le processus, pas le produit, en sciences";
export const description = "Le Digital Education Outlook 2026 de l'OCDE recommande officiellement 'l'évaluation orientée processus' pour l'ère de l'IA. Cette validation internationale confirme ce que WhimsyLabs construit depuis le début.";
...
export const content = (
  <>
    ...
    <h2>Pourquoi l'évaluation traditionnelle ne peut pas s'adapter</h2>
    ...
    <h2>Pourquoi les laboratoires scientifiques sont l'étude de cas parfaite</h2>
    ...
    <h2>Implications pour les écoles et les enseignants</h2>
    ...
    <h2>Le défi de la mise en œuvre</h2>
      ...
      <ul>
        <li>
          <a href="/fr/blog/process-based-lab-assessment-future">
            Évaluer le processus, pas la réponse : L'avenir de l'évaluation en laboratoire
          </a>
        </li>
        <li>
        ...
        <li>
          <a href="/fr/blog/oecd-ai-learning-paradox-virtual-labs">
            Le paradoxe de l'apprentissage par IA de l'OCDE et ce qu'il signifie pour les laboratoires virtuels
          </a>
        </li>
      </ul>
    </>
