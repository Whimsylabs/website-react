...
export const title = "OECD: Den Prozess bewerten, nicht das Produkt";
export const description = "Der OECD Digital Education Outlook 2026 empfiehlt offiziell 'prozessorientierte Bewertung' für das KI-Zeitalter. Diese internationale Bestätigung bekräftigt, was WhimsyLabs von Anfang an entwickelt hat.";
...
export const content = (
  <>
    ...
    <h2>Was genau empfiehlt die OECD?</h2>
    ...
    <h2>Warum kann sich die traditionelle Bewertung nicht anpassen?</h2>
    ...
    <h2>Warum Wissenschaftslabore die perfekte Fallstudie sind</h2>
    ...
    <p>
      <strong>Expertenpfadvergleich</strong> setzt das Verhalten der Schüler in einen Kontext. Wir haben kartiert, wie Expertenwissenschaftler an gängige Experimente herangehen, und identifiziert die Entscheidungsbäume und Problemlösungsmuster, die geschicktes wissenschaftliches Denken charakterisieren. Wenn der Ansatz eines Schülers erheblich von Expertenpfaden abweicht, signalisiert dies eine Gelegenheit für gezielte Anleitung.
    </p>

    <h2>Was die Forschung unterstützt</h2>

    <p>
      Die OECD-Empfehlung stimmt mit Jahrzehnten pädagogischer Forschung überein. Black und Wiliams wegweisende Überprüfung von 1998 zeigte, dass formative Bewertung, Feedback während des Lernens statt danach, erhebliche Lernfortschritte über alle Fächer und Altersgruppen hinweg erzeugt. Ihre Meta-Analyse fand Effektstärken zwischen 0,4 und 0,7, größer als fast jede andere pädagogische Intervention (
      <a
    ...
    <h2>Auswirkungen für Schulen und Lehrer</h2>
    ...
    <h2>Die Herausforderung der Umsetzung</h2>
      ...
      <ul>
        ...
        <li>
          <a href="/de/blog/ai-text-grading-fails-process-assessment-works">
            Warum KI-Textbewertung versagt und Prozessbewertung funktioniert
          </a>
        </li>
        <li>
          <a href="/de/blog/oecd-ai-learning-paradox-virtual-labs">
            Das OECD KI-Lernparadoxon und was es für virtuelle Labore bedeutet
          </a>
        </li>
      </ul>
    </>
