...
export const title = "Los Profesores Son Expertos. Nosotros Damos Herramientas.";
export const date = "2026-02-08";
export const slug = "teachers-are-experts-custom-experiment-designer";
export const description = "WhimsyLabs da control a los profesores con un diseñador de experimentos personalizado. Los profesores conocen a sus estudiantes.";
...
export const content = (
  <>
    ...
    <ul>
      ...
      <li><a href="/es/blog/edtech-vendor-security-questions-powerschool">10 preguntas para proveedores EdTech después de la brecha de PowerSchool</a></li>
