...
export const content = (
  <>
    <p>
      L'enquête 2026 du Higher Education Policy Institute sur l'IA générative des étudiants est arrivée la semaine dernière avec une statistique qui a fait les gros titres : 94% des étudiants britanniques de premier cycle utilisent maintenant l'IA générative pour les aider dans leurs travaux évalués (
      <a
      ...
      ). La réaction était prévisible. Certains commentateurs se sont lamentés sur l'intégrité académique. D'autres ont réclamé des outils de détection plus stricts. Quelques-uns ont suggéré d'accepter simplement la défaite et de laisser l'IA tout écrire.
    </p>
    ...
    <h2>Que montre réellement l'enquête HEPI ?</h2>
    ...
    <h2>Pourquoi la détection ne peut pas résoudre ce problème</h2>
    ...
    <p>
      Des analyses indépendantes ont révélé que les outils de détection d'IA produisent des taux de faux positifs entre 5% et 20%, ce qui signifie que le travail authentique des étudiants est régulièrement signalé comme généré par une machine (
      <a
    ...
    <h2>Le vrai problème : Évaluer des résultats qui ne nécessitent plus de réflexion humaine</h2>
    ...
    <h2>À quoi ressemble une évaluation résistante à l'IA ?</h2>

    <p>
      Les Perspectives de l'éducation numérique de l'OCDE 2026 ont répondu à cette question explicitement : "Au lieu de noter le travail final, les enseignants devraient évaluer comment un étudiant a interagi avec l'IA, comment il a critiqué ses résultats et comment il a affiné ses idées au fil du temps" (
      <a
      ...
      ). C'est l'évaluation orientée processus : évaluer non pas ce que les étudiants produisent, mais comment ils s'engagent dans l'apprentissage pour le produire.
    </p>
    ...
    <h2>Comment les laboratoires virtuels rendent possible l'évaluation des processus</h2>
    ...
    <h2>Ce que cela signifie pour l'enseignement des sciences</h2>
    ...
    <>
      ...
      <ul>
        <li>
          <a href="/fr/blog/oecd-process-oriented-assessment-validation">
            L'OCDE dit : Évaluez le processus, pas le produit
          </a>
        </li>
        <li>
          <a href="/fr/blog/ai-text-grading-fails-process-assessment-works">
            Pourquoi la notation de texte par IA échoue et l'évaluation des processus fonctionne
          </a>
        </li>
        <li>
          <a href="/fr/blog/process-based-lab-assessment-future">
            Noter le processus, pas la réponse : L'avenir de l'évaluation en laboratoire
          </a>
        </li>
        <li>
          <a href="/fr/blog/ai-assessment-crisis-solution">
            IA et la crise de l'évaluation : Une solution pratique
          </a>
        </li>
      </ul>
    </>
    ...
    <div className="references-section">
      ...
      <ul className="references-list">
        ...
        <li key="ref-3">
          OCDE. (2026). OECD Digital Education Outlook 2026: Exploring Effective Uses of Generative AI in Education. OECD Publishing.{" "}
