...
export const content = (
  <>
    <p>
      Die Umfrage des Higher Education Policy Institute zur generativen KI unter Studierenden 2026 wurde letzte Woche mit einer Statistik veröffentlicht, die Schlagzeilen machte: 94% der britischen Studierenden nutzen mittlerweile generative KI zur Unterstützung bei bewerteten Arbeiten (
      <a
      ...
      ). Die Reaktion war vorhersehbar. Einige Kommentatoren beklagten die akademische Integrität. Andere forderten strengere Erkennungstools. Einige wenige schlugen vor, einfach die Niederlage zu akzeptieren und KI alles schreiben zu lassen.
    </p>
    ...
    <h2>Was zeigt die HEPI-Umfrage tatsächlich?</h2>
    ...
    <h2>Warum Erkennung dieses Problem nicht lösen kann</h2>
    ...
    <p>
      Unabhängige Analysen haben ergeben, dass KI-Erkennungstools Falsch-Positiv-Raten zwischen 5% und 20% produzieren, was bedeutet, dass echte Studierendenarbeit routinemäßig als maschinengeneriert markiert wird (
      <a
    ...
    <h2>Das eigentliche Problem: Bewertung von Ergebnissen, die kein menschliches Denken mehr erfordern</h2>
    ...
    <h2>Wie sieht KI-sichere Bewertung aus?</h2>

    <p>
      Der OECD Digital Education Outlook 2026 beantwortete diese Frage explizit: "Anstatt die Abschlussarbeit zu benoten, sollten Lehrkräfte bewerten, wie ein Studierender mit KI interagiert hat, wie er deren Ausgabe kritisiert hat und wie er seine Ideen im Laufe der Zeit verfeinert hat" (
      <a
      ...
      ). Dies ist prozessorientierte Bewertung: nicht bewerten, was Studierende produzieren, sondern wie sie sich mit dem Lernen beschäftigen, um es zu produzieren.
    </p>
    ...
    <h2>Wie virtuelle Labore Prozessbewertung ermöglichen</h2>
    ...
    <h2>Was das für die naturwissenschaftliche Bildung bedeutet</h2>
    ...
    <>
      ...
      <ul>
        <li>
          <a href="/de/blog/oecd-process-oriented-assessment-validation">
            OECD sagt: Bewerten Sie den Prozess, nicht das Produkt
          </a>
        </li>
        <li>
          <a href="/de/blog/ai-text-grading-fails-process-assessment-works">
            Warum KI-Textbewertung scheitert und Prozessbewertung funktioniert
          </a>
        </li>
        <li>
          <a href="/de/blog/process-based-lab-assessment-future">
            Den Prozess bewerten, nicht die Antwort: Die Zukunft der Laborbewertung
          </a>
        </li>
        <li>
          <a href="/de/blog/ai-assessment-crisis-solution">
            KI und die Bewertungskrise: Eine praktische Lösung
          </a>
        </li>
      </ul>
    </>
