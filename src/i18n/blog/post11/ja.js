...
export const description =
  "従来の物理的な実験室とWhimsyLabsのシミュレーション教材ソリューションとの包括的な費用対効果の比較。社会的影響を重視したアプローチがどのようにSTEM教育を民主化するかをご紹介します。";
...
export const content = (
  <div>
    ...
    <p>
      従来の実験室は、コストと時間の制約のために実験を配給します。生徒は評価の前に滴定を1回または2回実行する可能性があります。WhimsyLabsは無制限の反復を可能にします:生徒は真の習得が達成されるまで滴定を練習し、技法の変動が結果にどのように影響するかを探求し、実験を通じて仮説をテストし、繰り返しの物理的パフォーマンスを通じて筋肉記憶を構築できます。研究は、スキルの習得には広範な練習が必要であることを示していますが、従来の実験室の制約はこれを経済的に不可能にします(
      <a
