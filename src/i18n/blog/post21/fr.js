// French - Post 21: Royal Society Partnership Grants
import React from "react";

export const title = "Écoles UK : 3 000 £ pour Labos RV via Royal Society";
export const description =
  "Les bourses Royal Society Partnership offrent 3 000 £ aux écoles UK pour des projets STEM. WhimsyLabs vous aide à postuler.";
  ...
  <>
    <figure className="blog-image">
      <img
        ...
        alt="Élèves utilisant le laboratoire de sciences VR WhimsyLabs dans une salle de classe britannique"
      ...
      <figcaption style={{ textAlign: 'center', fontStyle: 'italic', color: '#666', marginBottom: '1.5rem' }}>
        Laboratoire de sciences VR WhimsyLabs dans une salle de classe britannique
      </figcaption>
    </figure>
    ...
    <p>
      Le programme de bourses Royal Society Partnership finance des projets STEM investigatifs qui mettent en relation les écoles avec des scientifiques en activité. Il est conçu pour offrir aux élèves des expériences de recherche authentiques tout en construisant des relations durables entre l'éducation et le monde académique.
    </p>
    <p>
      Voici ce qui rend ces bourses spéciales :
    </p>
    <ul>
    ...
    <h2>Pourquoi des laboratoires de sciences en RV ?</h2>
    <p>
    ...
    <div style={{ position: 'relative', paddingBottom: '56.25%', height: 0, overflow: 'hidden', maxWidth: '700px', margin: '2rem auto', borderRadius: '8px' }}>
      <iframe
        ...
        title="Démonstration du laboratoire de sciences VR WhimsyLabs"
    ...
    <h2>Dates de candidature 2026</h2>
    <p>
    ...
    <h2>Comment WhimsyLabs vous aide à postuler</h2>
    <p>
      Nous avons lancé une <a href="/grants/royal-society/">page dédiée aux bourses Royal Society Partnership</a> parce que nous voulons voir plus d'écoles réussir leurs candidatures. Voici ce que nous offrons :
    </p>
    ...
    <p>
      Vous n'avez jamais rédigé de demande de bourse ? Pas de problème. Nous pouvons vous aider à articuler les bénéfices éducatifs de la RV, suggérer des structures de projet alignées avec les critères de la Royal Society, et relire votre brouillon avant soumission.
    </p>
    ...
    <p>
      Qu'est-ce qui fait une investigation scientifique en RV convaincante ? Nous travaillerons avec vous pour concevoir un projet éducativement significatif, techniquement réalisable et aligné avec votre programme scolaire. Que ce soit l'étude des vitesses de réaction en chimie virtuelle ou l'exploration des forces dans des simulations de physique, nous vous aiderons à trouver le bon axe.
    </p>

    <h3>Formation et support continu</h3>
    <p>
      La technologie RV n'est utile que si les enseignants se sentent à l'aise pour l'utiliser. Nous fournissons une formation complète sur WhimsyLabs, ainsi qu'un support technique continu tout au long de votre projet.
    </p>

    <h2>Que peut financer la bourse ?</h2>
    <p>
    ...
    <p>
      La plupart des écoles publiques britanniques peuvent postuler. Les principales exigences sont :
    </p>
    <ul>
    ...
    <p>
      Besoin d'inspiration ? Voici quelques concepts de projets qui fonctionnent bien avec WhimsyLabs :
    </p>

    <h3>Chimie</h3>
    <ul>
      <li>Étudier comment les variables affectent la précision des titrages</li>
      <li>Comparer le développement des techniques des élèves en RV vs méthodes traditionnelles</li>
      <li>Concevoir et tester de nouveaux protocoles de réaction</li>
    </ul>

    <h3>Physique</h3>
    <ul>
      <li>Explorer le mouvement et les forces à travers des expériences virtuelles</li>
      <li>Tester la précision des simulations physiques par rapport aux données du monde réel</li>
      <li>Étudier les facteurs affectant la précision des mesures</li>
    </ul>

    <h3>Biologie</h3>
    <ul>
      <li>Formation et évaluation des techniques de dissection virtuelle</li>
      <li>Comparer les résultats d'apprentissage entre spécimens virtuels et physiques</li>
      <li>Études d'accessibilité pour les élèves ne pouvant pas participer aux dissections traditionnelles</li>
    </ul>
