// Spanish - Post 33: EdTech Critics Response
import React from "react";

export const title = "Los Críticos Tienen Razón: La Mayoría del EdTech Es Inútil";
export const description = "Las escuelas de EE.UU. gastaron $30 mil millones en EdTech en 2024. Los críticos tienen razón sobre el tiempo pasivo en pantallas. Pero los laboratorios virtuales que hacen que los estudiantes HAGAN ciencia con un tutor IA? Eso es diferente.";
...
export const content = (
  <>
    <p>
      <em>"¿Es la tecnología educativa mayormente inútil?"</em> pregunta{" "}
      <a
      ...
      . <em>"Los niños pasan horas en la escuela frente a pantallas. ¿Y para qué?"</em> replica{" "}
      <a
    ...
    <p>
      ...
      hace esta distinción clara. Cuando las herramientas de IA de propósito general simplemente se entregan a los estudiantes sin estructura, el aprendizaje frecuentemente <em>disminuye</em> porque los estudiantes externalizan su pensamiento a la máquina. Sin embargo, la IA diseñada con <strong>"propósito pedagógico intencional"</strong> muestra mejoras sostenidas. La diferencia no es si la tecnología está presente. Es si la tecnología requiere que el alumno participe activamente.
    </p>
    ...
    <p>
      ...
      refuerza este punto: <em>"sin una estrategia centrada en el ser humano, incluso la mejor tecnología fracasará."</em> Muchas escuelas compraron la tecnología sin comprar la estrategia para implementarla eficazmente.
    </p>

    <h2>¿Qué Hace Diferente al Aprendizaje Activo?</h2>

    <p>
      Existe un cuerpo sustancial de investigación sobre el <strong>aprendizaje activo</strong>, demostrando que los estudiantes aprenden más eficazmente cuando hacen cosas en lugar de ver cosas. Un meta-análisis histórico de 225 estudios encontró que el aprendizaje activo mejoró el rendimiento en exámenes en medio punto de nota y redujo las tasas de fracaso en un 55% comparado con la enseñanza tradicional (
      <a
        href="https://www.pnas.org/doi/10.1073/pnas.1319030111"
        target="_blank"
        rel="noopener noreferrer"
      ...
      ). La pregunta para los educadores siempre ha sido: ¿cómo crear experiencias de aprendizaje activo a escala?
    </p>
    ...
    <p>
      Sin embargo, hay algo que la IA generadora de texto fundamentalmente no puede hacer: <strong>realizar físicamente un procedimiento</strong>.
    </p>

    <p>
      Nuestro <strong>tutor de inteligencia artificial</strong>, WhimsyCat, observa <em>cómo</em> trabajan los estudiantes, no solo qué respuestas escritas producen. ¿Sostuvieron la pipeta en el ángulo correcto? ¿Se aproximaron al punto final de una valoración lo suficientemente lento? ¿Recordaron enjuagar la bureta antes de llenarla? ¿Leyeron el menisco a nivel de los ojos? Estas son acciones físicas capturadas en tiempo real. No pueden externalizarse a un generador de texto porque no son texto. Son movimiento, temporización, razonamiento espacial y conocimiento procedimental demostrado a través de la acción.
    </p>

    <p>
      La investigación reciente de Pearson sobre evaluación ha identificado las habilidades prácticas como inherentemente <strong>resistentes a la IA</strong>, no porque alguien esté bloqueando deliberadamente la IA, sino porque las habilidades mismas requieren demostración física que los modelos de lenguaje no pueden proporcionar. No puedes falsificar la técnica de valoración pidiendo a ChatGPT. Tienes que hacerla realmente.
    </p>
    ...
    <h2>¿Cómo Es Realmente la Tecnología Educativa Centrada en el Ser Humano?</h2>

    <p>
      El informe de CoSN enfatiza que la tecnología educativa exitosa requiere una <em>"estrategia centrada en el ser humano."</em> Tomamos este principio en serio. WhimsyLabs no está diseñado para reemplazar a los profesores de ciencias. Está diseñado para apoyarles en la gestión de una carga de trabajo cada vez más imposible.
    </p>
    ...
    <h2>¿Qué Preguntas Deberíamos Hacer Sobre la Tecnología Educativa?</h2>
    ...
    <ul>
      <li><strong>¿Requiere esta tecnología participación activa?</strong> Si los estudiantes pueden usarla mientras están medio atentos, probablemente es pasiva.</li>
      <li><strong>¿Evalúa el proceso o solo los resultados?</strong> Los cuestionarios de opción múltiple capturan solo las respuestas finales. Pierden el razonamiento y la técnica que más importan.</li>
      <li><strong>¿Apoya a los profesores o intenta reemplazarlos?</strong> El reemplazo del profesor ha fracasado repetidamente. La potenciación del profesor muestra promesas genuinas.</li>
      <li><strong>¿Hay evidencia de transferencia del aprendizaje?</strong> ¿Los estudiantes que usan esta tecnología rinden mejor en contextos del mundo real?</li>
      <li><strong>¿Fue diseñada con intención pedagógica?</strong> ¿O fue diseñada por ingenieros que asumieron que el aprendizaje ocurriría automáticamente una vez desplegada la tecnología?</li>
    </ul>
    ...
    <p>
      ¿<strong>Laboratorios virtuales</strong> donde los estudiantes realizan físicamente experimentos, reciben coaching en tiempo real sobre su técnica y demuestran habilidades que la IA no puede replicar? Eso representa una categoría fundamentalmente diferente de tecnología educativa para la <strong>educación STEM</strong>.
    </p>

    <h2>¿Qué Evidencia Respalda Este Enfoque?</h2>

    <p>
      No pedimos a nadie que acepte estas afirmaciones por fe. En BETT 2025, los propios estudiantes votaron por WhimsyLabs en los <strong>Kids' Choice Awards</strong>, reconociendo la plataforma por hacer la ciencia atractiva y accesible. En BETT 2026, <strong>Tech & Learning nos nombró Best of BETT</strong>. Estos no son premios de marketing. Representan reconocimiento de educadores y estudiantes que realmente usaron el producto y lo encontraron valioso.
    </p>

    <p>
      Estamos realizando investigación continua con escuelas asociadas midiendo la transferencia de habilidades prácticas. Los resultados iniciales indican que los estudiantes que practican procedimientos en WhimsyLabs demuestran técnica mejorada cuando posteriormente trabajan en laboratorios físicos. La práctica en el <strong>laboratorio virtual</strong> se transfiere al rendimiento del mundo real. El enfoque sandbox desarrolla el pensamiento de diseño experimental que los laboratorios tradicionales estilo receta luchan por cultivar.
    </p>
    ...
    <p>
      El debate sobre la tecnología educativa no debería enmarcarse como "tecnología versus sin tecnología." Esa elección ya no está disponible. La tecnología está integrada en la educación y permanecerá así. El debate productivo concierne a <em>qué tipo</em> de tecnología, diseñada según <em>qué principios</em>, implementada con <em>qué estrategias</em>.
    </p>
    ...
    <p>
      Entornos de <strong>aprendizaje activo</strong> que requieren participación genuina. Evaluación que rastrea el proceso y la técnica en lugar de solo las respuestas finales. Tecnología que apoya a los profesores en lugar de intentar reemplazarlos. Plataformas que hacen la ciencia práctica accesible para escuelas que no pueden permitirse o dotar de personal laboratorios tradicionales. Herramientas que desarrollan habilidades que la IA no puede falsificar.
    </p>
