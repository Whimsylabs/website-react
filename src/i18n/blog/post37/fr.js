...
export const title = "Évaluer le Processus, Pas la Réponse : l'Avenir du Laboratoire";
export const description = "L'Université d'État de l'Arizona évalue désormais les étudiants sur leur processus de raisonnement dans les laboratoires virtuels, pas seulement sur les réponses finales. Ce passage à l'évaluation basée sur le processus reflète ce que WhimsyLabs a construit depuis le début.";
...
export const content = (
  <>
    ...
    <p>
      L'Université d'État de l'Arizona, à travers son partenariat avec{" "}
      <a
      ...
      , a été pionnière dans une approche qui évalue les étudiants non pas sur s'ils ont atteint la bonne conclusion, mais sur <strong>comment ils ont raisonné à travers le problème</strong>. Leurs laboratoires de biologie immersifs suivent les étapes logiques que prennent les étudiants, les hypothèses qu'ils forment, les données qu'ils collectent et les connexions qu'ils établissent.
    </p>

    <h2>Pourquoi l'Évaluation Traditionnelle de Laboratoire Échoue-t-elle ?</h2>
    ...
    <p>
      Les premiers résultats ont été frappants. Une{" "}
      <a
        href="https://www.dreamscapelearn.com/research"
        target="_blank"
        rel="noopener noreferrer"
      >
        étude publiée par le EdPlus Action Lab de l'ASU
      </a>{" "}
      a révélé que les étudiants des cours de biologie Dreamscape Learn ont montré des notes de laboratoire significativement plus élevées et un meilleur engagement que leurs pairs dans les cours conventionnels.
    </p>

    <h2>Comment Suivre le Raisonnement Scientifique ?</h2>
    ...
    <p>
      <strong>L'enregistrement des interactions</strong> capture chaque action dans l'environnement virtuel. Quand un étudiant prend une pipette virtuelle, le système l'enregistre. Quand il mesure le pH, le système enregistre la séquence de mesures. Ces journaux créent une chronologie du comportement qui peut être analysée pour des motifs.
    </p>

    <p>
      <strong>Les arbres de décision</strong> cartographient les chemins logiques à travers un problème. Les scientifiques experts résolvent les problèmes selon des schémas caractéristiques : ils forment des hypothèses, conçoivent des tests, collectent des données systématiquement et révisent leur compréhension en fonction des preuves. Les novices montrent souvent des schémas différents : exploration aléatoire ou engagement prématuré envers les hypothèses initiales.
    </p>

    <p>
      <strong>L'analyse par IA</strong> identifie des motifs à travers des milliers d'interactions d'étudiants. Les modèles d'apprentissage automatique peuvent classifier les stratégies de raisonnement, détecter quand les étudiants sont bloqués et prédire lesquels bénéficieraient d'une intervention.
    </p>

    <h2>Pourquoi Cela Compte à l'Ère de l'IA Générative</h2>
    ...
    <p>
      L'évaluation basée sur le processus offre une solution. Quand vous évaluez comment les étudiants raisonnent plutôt que ce qu'ils concluent, les réponses générées par IA deviennent non pertinentes. Un étudiant ne peut pas utiliser ChatGPT pour effectuer des expériences virtuelles à sa place. Le processus de raisonnement doit être le sien. Cela rend l'évaluation basée sur le processus non seulement pédagogiquement supérieure mais <strong>authentiquement résistante à l'IA</strong>.
    </p>

    <h2>Comment WhimsyLabs a Toujours Fait Cela</h2>
    ...
    <ul>
      <li><strong>Les étudiants « savent » souvent quelque chose théoriquement mais ne l'appliquent pas pratiquement.</strong> Un étudiant peut expliquer correctement l'importance d'agiter pendant le titrage mais ne pas agiter lorsqu'il effectue réellement la procédure.</li>
      <li><strong>La vitesse d'achèvement correct ne corrèle pas avec la compréhension.</strong> Certains étudiants se précipitent et obtiennent des réponses correctes par chance. D'autres travaillent lentement et méthodiquement, démontrant une meilleure compréhension même quand ils font des erreurs.</li>
      <li><strong>Les schémas d'erreur se regroupent par misconception.</strong> Les étudiants avec des malentendus conceptuels similaires font des erreurs similaires.</li>
      <li><strong>Les trajectoires d'amélioration varient considérablement.</strong> Certains étudiants montrent une amélioration constante sur plusieurs sessions. D'autres stagnent. D'autres régressent.</li>
    </ul>

    <h2>Le Défi de la Mise en Œuvre Pratique</h2>
    ...
    <h2>De la Notation au Coaching</h2>
