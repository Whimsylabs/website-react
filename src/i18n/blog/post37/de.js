...
export const title = "Den Prozess bewerten, nicht die Antwort: Zukunft der Laborbewertung";
export const description = "Die Arizona State University bewertet Studierende jetzt nach ihrem Denkprozess in virtuellen Laboren, nicht nur nach den Endergebnissen. Diese Verlagerung zur prozessbasierten Bewertung spiegelt wider, was WhimsyLabs von Anfang an entwickelt hat.";
...
export const content = (
  <>
    ...
    <p>
      Die Arizona State University hat durch ihre Partnerschaft mit{" "}
      <a
      ...
      einen Ansatz entwickelt, der Studierende nicht danach bewertet, ob sie zur richtigen Schlussfolgerung gelangt sind, sondern danach, <strong>wie sie sich durch das Problem gedacht haben</strong>. Ihre immersiven Biologielabore verfolgen die logischen Schritte, die Studierende unternehmen, die Hypothesen, die sie bilden, die Daten, die sie sammeln, und die Verbindungen, die sie herstellen.
    </p>

    <h2>Warum versagt die traditionelle Laborbewertung?</h2>
    ...
    <p>
      Frühe Ergebnisse waren beeindruckend. Eine{" "}
      <a
        href="https://www.dreamscapelearn.com/research"
        target="_blank"
        rel="noopener noreferrer"
      >
        Studie des EdPlus Action Lab der ASU
      </a>{" "}
      ergab, dass Studierende in Dreamscape Learn-Biologiekursen deutlich bessere Labornoten und besseres Engagement zeigten als Gleichaltrige in konventionellen Kursen.
    </p>

    <h2>Wie verfolgt man wissenschaftliches Denken?</h2>
    ...
    <ul>
      <li><strong>Studierende "wissen" oft etwas theoretisch, wenden es aber praktisch nicht an.</strong> Ein Student kann die Wichtigkeit des Schwenkens während der Titration korrekt erklären, aber beim tatsächlichen Durchführen nicht schwenken.</li>
      <li><strong>Geschwindigkeit der korrekten Fertigstellung korreliert nicht mit Verständnis.</strong> Manche Studierende eilen durch Experimente und erhalten durch Glück richtige Antworten. Andere arbeiten langsam und methodisch und zeigen besseres Verständnis, selbst wenn sie Fehler machen.</li>
      <li><strong>Fehlermuster gruppieren sich nach Missverständnissen.</strong> Studierende mit ähnlichen konzeptuellen Missverständnissen machen ähnliche Fehler.</li>
      <li><strong>Verbesserungstrajektorien variieren dramatisch.</strong> Manche Studierende zeigen stetige Verbesserung über mehrere Sitzungen. Andere stagnieren. Andere verschlechtern sich.</li>
    </ul>

    <h2>Die praktische Implementierungsherausforderung</h2>
    ...
    <h2>Von Bewertung zu Coaching</h2>
    ...
    <h2>Die Zukunft ist bereits da</h2>
