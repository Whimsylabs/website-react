...
export const title = "Triple Science para todos en 2028: cómo impartir las prácticas";
export const description =
  "Un derecho a Triple Science llega en septiembre de 2028, pero el trabajo práctico se ha reducido casi a la mitad desde 2016. Esto es cómo los laboratorios virtuales ayudan a los colegios a impartirlo.";
...
export const content = (
  <>
    ...
    <h2>¿Qué exige realmente el derecho a Triple Science?</h2>
    ...
    <p>
      ...
      ). Los colegios menos capaces de ofrecer Triple Science hoy suelen ser los que sirven a comunidades desfavorecidas, que a menudo tienen los menos laboratorios, el menor tiempo de técnicos y la contratación más difícil. Un derecho sobre el papel no crea un laboratorio libre ni un especialista en física.
    </p>

    <h2>El declive silencioso del trabajo práctico</h2>

    <p>
      La tendencia contra la que choca el derecho está bien documentada. El Science Education Tracker de la Royal Society y EngineeringUK halló que la proporción de alumnos de GCSE que realizan trabajo práctico al menos cada dos semanas cayó del 44% en 2016 al 26% en 2023, con demostraciones en vídeo sustituyendo cada vez más a experimentos que los alumnos solían realizar ellos mismos (
      <a
    ...
    <h2>Por qué no puedes construir tu salida para 2028</h2>
    ...
    <h2>Cómo los laboratorios virtuales añaden capacidad práctica sin salas nuevas</h2>
    ...
    <h2>Pero, ¿es "real" el trabajo práctico virtual?</h2>
    ...
    <h2>Qué pueden hacer los líderes de colegios y trusts antes de 2028</h2>
      ...
      <ul>
        <li>
          <a href="/blog/send-white-paper-2026-science-practicals">
            Qué significa el Libro Blanco SEND 2026 para la enseñanza de ciencias
          </a>
        </li>
        <li>
          <a href="/blog/virtual-labs-solve-stem-teacher-shortage-crisis">
            Cómo los laboratorios virtuales ayudan a resolver la crisis de escasez de profesores STEM
          </a>
        </li>
        <li>
          <a href="/blog/virtual-labs-vs-physical-labs-cost-benefit-analysis">
            Laboratorios virtuales frente a laboratorios físicos: un análisis de coste-beneficio
          </a>
        </li>
        <li>
          <a href="/blog/how-to-choose-virtual-lab-software-school">
            Cómo elegir un software de laboratorio virtual para tu colegio
          </a>
        </li>
      </ul>
    </>
