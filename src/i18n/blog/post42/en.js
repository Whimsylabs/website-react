...
export const title = "Triple Science for All by 2028: Delivering the Practicals";
export const description =
  "A Triple Science entitlement arrives for September 2028, but hands-on practical work has nearly halved since 2016. Here is how virtual labs help schools deliver it.";
...
export const content = (
  <>
    <p>
      When the Curriculum and Assessment Review published its final report in November 2025, one science recommendation stood out: a statutory entitlement for any student who wants to study the separate sciences, biology, chemistry and physics, as three GCSEs. The government accepted it, committing to support schools to build a Triple Science offer ahead of introducing the entitlement, with a revised national curriculum due in spring 2027 and first teaching from September 2028 (
      <a
        href="https://www.gov.uk/government/news/new-curriculum-to-give-young-people-the-skills-for-life-and-work"
        target="_blank"
    ...
    <h2>Why Is the Entitlement So Hard to Deliver?</h2>

    <p>
      Three binding constraints sit in the way, and the Review itself acknowledged them: timetabling pressure, laboratory capacity, and a shortage of specialist teachers, especially in physics. The concern that the plan risks running ahead of the physics teaching workforce was raised immediately on publication (
      <a
        href="https://www.tes.com/magazine/news/secondary/curriculum-review-triple-science-teacher-shortages"
        target="_blank"
        rel="noopener noreferrer"
      >
        Tes, 2025
      </a>
      ). The schools least able to offer Triple Science today are typically those serving disadvantaged communities, which often have the fewest labs, the least technician time and the hardest recruitment. An entitlement on paper does not create a free laboratory or a physics specialist.
    </p>

    <h2>The Quiet Decline of Hands-On Practical Work</h2>

    <p>
      The trend the entitlement runs against is well documented. The Royal Society and EngineeringUK Science Education Tracker found that the proportion of GCSE pupils doing hands-on practical work at least fortnightly fell from 44% in 2016 to 26% in 2023, with video demonstrations increasingly standing in for experiments pupils used to carry out themselves (
      <a
    ...
    <h2>Why You Cannot Build Your Way Out by 2028</h2>
    ...
    <h2>How Virtual Labs Add Practical Capacity Without New Rooms</h2>
    ...
    <h2>But Is Virtual Practical Work "Real"?</h2>
    ...
    <h2>What School and Trust Leaders Can Do Before 2028</h2>
      ...
      <ul>
        ...
        <li>
          <a href="/blog/virtual-labs-solve-stem-teacher-shortage-crisis">
            How Virtual Labs Help Solve the STEM Teacher Shortage Crisis
          </a>
        </li>
        <li>
    ...
    <div className="references-section">
      ...
      <ul className="references-list">
        <li key="ref-1">
          Department for Education. (2025). New curriculum to give young people the skills for life and work. GOV.UK.{" "}
          <a href="https://www.gov.uk/government/news/new-curriculum-to-give-young-people-the-skills-for-life-and-work" target="_blank" rel="noopener noreferrer">
            https://www.gov.uk/government/news/new-curriculum-to-give-young-people-the-skills-for-life-and-work
          </a>
        </li>
        <li key="ref-2">
          Department for Education. (2025). Government response to the Curriculum and Assessment Review.{" "}
          <a href="https://assets.publishing.service.gov.uk/media/690b2a4a14b040dfe82922ea/Government_response_to_the_Curriculum_and_Assessment_Review.pdf" target="_blank" rel="noopener noreferrer">
        ...
        <li key="ref-4">
          Tes. (2025). Triple science GCSE plan 'ignores chronic teacher shortages'.{" "}
          <a href="https://www.tes.com/magazine/news/secondary/curriculum-review-triple-science-teacher-shortages" target="_blank" rel="noopener noreferrer">
            https://www.tes.com/magazine/news/secondary/curriculum-review-triple-science-teacher-shortages
          </a>
        </li>
      </ul>
    </div>
