...
export const title = "Premium-Naturwissenschaftsunterricht für jede Schule zugänglich machen";
export const description = "Premium-EdTech sollte nicht nur wohlhabenden Schulen vorbehalten sein. Erfahren Sie, wie Fördermittel und Zuschüsse physikgenaue virtuelle Labore in jeden Klassenraum bringen können.";
  ...
  <>
    <figure className="blog-image">
      <img
        ...
        alt="Schüler aus verschiedenen Schulen nutzen das virtuelle WhimsyLabs-Wissenschaftslabor"
      ...
      <figcaption style={{ textAlign: 'center', fontStyle: 'italic', color: '#666', marginBottom: '1.5rem' }}>
        Premium-Naturwissenschafts-Bildungstechnologie, zugänglich durch Fördermittel
      </figcaption>
    </figure>
    ...
    <p>
      Das ist kein abstraktes Anliegen. Forschung zeigt durchweg, dass der Zugang zu qualitativ hochwertigen Bildungsressourcen die Ergebnisse beeinflusst. Ein <a href="https://www.nfer.ac.uk/publications/science-education-2019/" target="_blank" rel="noopener noreferrer">NFER-Bericht von 2019</a> stellte fest, dass Schulen in benachteiligten Gebieten deutlich häufiger keine angemessene naturwissenschaftliche Ausstattung haben. Das Ergebnis: Schüler aus ärmeren Verhältnissen erhalten weniger Möglichkeiten, praktische naturwissenschaftliche Fähigkeiten zu entwickeln.
    </p>
    <p>
    ...
    <h2>Warum „Billig" nicht die Antwort ist</h2>
    <p>
    ...
    <p>
      Lehrer durchschauen das sofort. Eine <a href="https://doi.org/10.1007/s10956-020-09862-4" target="_blank" rel="noopener noreferrer">Studie von 2020 im Journal of Science Education and Technology</a> ergab, dass die Wahrnehmung der Technologiequalität durch Lehrer direkt beeinflusst, wie viel sie diese im Unterricht nutzen. Geben Sie Lehrern eine fehlerhafte Simulation, und sie werden sie innerhalb von Wochen aufgeben. Die billige Lösung wird zu gar keiner Lösung.
    </p>
    <p>
    ...
    <h2>Die echte Lösung: Förderungen und Finanzierung</h2>
    <p>
    ...
    <h3>Fördermöglichkeiten in Großbritannien</h3>
    <p>
      Das <a href="/blog/royal-society-partnership-grants-vr-science-labs">Royal Society Partnership Grants</a>-Programm bietet britischen staatlichen Schulen bis zu 3.000 £ für investigative MINT-Projekte. Wir haben mit Dutzenden von Schulen zusammengearbeitet, um diese Zuschüsse für VR-Wissenschaftslabore zu sichern. Die Royal Society stellt die Finanzierung für Hardware bereit. Wir stellen die Software kostenlos zur Verfügung.
    </p>
    <p>
      Über die Royal Society hinaus können britische Schulen auf folgende Mittel zugreifen:
    </p>
    <ul>
      <li><strong>STEM Learning Network-Zuschüsse</strong> für Lehrerweiterbildung und Ressourcen</li>
      <li><strong>Institute of Physics-Ausstattungszuschüsse</strong> speziell für den Physikunterricht</li>
      <li><strong>Royal Society of Chemistry-Zuschüsse</strong> für Chemiebildungsinitiativen</li>
      <li><strong>Lokale MINT-Fonds der Behörden</strong>, die je nach Region variieren, aber beträchtlich sein können</li>
      <li><strong>Innovationsbudgets von Multi-Academy Trusts</strong>, die oft für Technologie-Pilotprojekte reserviert sind</li>
    </ul>
    <p>
    ...
    <h3>Internationale Finanzierungsquellen</h3>
    <p>
    ...
    <h3>Unterstützung bei der Bewerbung</h3>
    <p>
    ...
    <h3>WhimsyLabs: Ihr MINT-Partner</h3>
    <p>
      Einige Förderungen, wie die Royal Society Partnership Grants, erfordern einen MINT-Partner aus Industrie oder Wissenschaft. <strong>WhimsyLabs erfüllt diese Anforderung.</strong> Unser Team umfasst promovierte Wissenschaftler und Forscher, die als Ihr offizieller MINT-Partner fungieren können, sodass Ihre Bewerbung vollständig ist, ohne dass Sie externe Kontakte finden müssen.
    </p>

    <h3>Kostenlose Software für geförderte Projekte</h3>
    <p>
    ...
    <h2>Was „Premium" wirklich bedeutet</h2>
    <p>
    ...
    <p>
      Das ist wichtig, weil es bei naturwissenschaftlicher Bildung nicht nur darum geht, die richtige Antwort zu bekommen. Es geht darum, zu verstehen, wie sich die physische Welt verhält. Forschung zeigt, dass <a href="https://doi.org/10.1103/PhysRevSTPER.6.020108" target="_blank" rel="noopener noreferrer">physikbasierte Simulationen auf das Verständnis der realen Welt übertragen werden</a>, in einer Weise, die vereinfachte Animationen nicht können.
    </p>

    <h3>KI-Tutoring, das funktioniert</h3>
    <p>
    ...
    <h3>Datenschutz richtig gemacht</h3>
    <p>
    ...
    <ul>
      <li>Eine Gesamtschule in den Midlands erhielt Royal Society-Finanzierung und führt jetzt VR-Chemiepraktika für Schüler der 10. und 11. Klasse durch. Ihre GCSE-Praktikumsbewertungsergebnisse verbesserten sich merklich im ersten Jahr.</li>
      <li>Eine Schule in Schottland nutzte lokale MINT-Fördermittel, um WhimsyLabs in ihrer Physikabteilung zu pilotieren. Nach dem Pilotprojekt expandierten sie mit Unterstützung des Multi-Academy Trust auf Chemie und Biologie.</li>
      <li>Eine internationale Schule in Deutschland nutzte Erasmus+-Finanzierung für ein grenzüberschreitendes naturwissenschaftliches Bildungsprojekt und verwendete WhimsyLabs als gemeinsame Plattform zwischen den Partnerschulen.</li>
    </ul>
    <p>
    ...
    <h2>Qualifiziert sich Ihre Schule?</h2>
    <p>
    ...
    <h2>Loslegen</h2>
    <p>
      Wenn Sie daran interessiert sind, WhimsyLabs durch Förderfinanzierung an Ihre Schule zu bringen, helfen wir Ihnen gerne. Beginnen Sie mit dem Besuch unserer <a href="/grants">Seite für Förderungen und Finanzierung</a>. Sie finden dort Details zu spezifischen Fördermöglichkeiten und wie wir Ihre Bewerbung unterstützen können.
    </p>
    <p>
    ...
    <ul>
      ...
      <li><a href="/blog/virtual-labs-vs-physical-labs-cost-benefit-analysis">Virtuelle Labore vs. Physische Labore: Der echte Kostenvergleich</a></li>
      <li><a href="/blog/whimsycat-ai-tutor-transforming-science-education">Lernen Sie WhimsyCat kennen: Der KI-Tutor, der Naturwissenschaften wirklich versteht</a></li>
      <li><a href="/blog/data-security-edtech-vendor-questions">10 Fragen, die Sie EdTech-Anbietern zur Datensicherheit stellen sollten</a></li>
    </ul>
  </>
);
