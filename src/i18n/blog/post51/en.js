...
export const content = (
  <>
    <p>
      ...
      ). Accredited providers now teach the full British curriculum to tens of thousands of pupils, some of them in different hemispheres from their teachers.
    </p>
    ...
    <h2>Why Is Practical Science the Hardest Part of Online Schooling?</h2>
    ...
    <h2>What Do Online Schools Currently Do About Practicals?</h2>
    ...
    <p>
      That inversion is the part most schools miss, and it is worth stating plainly: the value of a good simulation to an online school is not only that it replaces bench time the school cannot provide. It is that it makes the bench time the school <em>can</em> provide worth several times more.
    </p>
    ...
    <>
      ...
      <ul>
        <li>
          <a href="/blog/flipped-practical-preloading-lab-skills">
            The Flipped Practical: Arriving at the Bench Already Competent
          </a>
        </li>
        <li>
          <a href="/blog/ib-diploma-science-practicals-virtual-labs">
