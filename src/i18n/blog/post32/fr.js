// French - Post 32: Pearson Webinar
import React from "react";

export const title = "L'évaluation à l'ère de l'IA : Rejoignez notre webinaire Pearson";
export const description = "Dr Marisa French intervient lors du webinaire de la communauté des praticiens de l'immersif de Pearson le 26 février 2026. Découvrez comment la RV permet une évaluation axée sur le processus qui rend la triche par IA obsolète.";
  ...
  <>
    <figure className="blog-image">
      <img
        ...
        alt="Tableau de bord enseignant affichant l'aperçu des évaluations IA et le journal d'audit"
      ...
      <figcaption style={{ textAlign: 'center', fontStyle: 'italic', color: '#666', marginBottom: '1.5rem' }}>
        Les enseignants peuvent examiner et auditer les décisions de notation de l'IA via un tableau de bord intuitif.
      </figcaption>
    </figure>
    ...
    <p>
      C'est exactement ce dont je parlerai lors du <strong>webinaire de la communauté des praticiens de l'immersif de Pearson</strong> le <strong>jeudi 26 février 2026</strong>. Si vous êtes un éducateur britannique intéressé par la façon dont la technologie immersive peut transformer l'évaluation, j'aimerais beaucoup que vous nous rejoigniez.
    </p>

    <h2>Détails de l'événement</h2>
    <ul>
      <li><strong>Date :</strong> Jeudi 26 février 2026</li>
      <li><strong>Heure :</strong> 15h30 à 17h00 (Royaume-Uni)</li>
      <li><strong>Format :</strong> Webinaire en ligne avec questions-réponses</li>
      <li><strong>Public :</strong> Éducateurs britanniques des écoles, collèges et enseignement supérieur</li>
      <li><strong>Coût :</strong> Gratuit</li>
    </ul>
    <p>
      <strong><a href="https://pearson.cventevents.com/YaQgOy" target="_blank" rel="noopener noreferrer">Inscrivez-vous ici →</a></strong>
    </p>
    ...
    <ul>
      <li><strong>Recherche de Pearson sur l'IA générative :</strong> Ce que les données nous révèlent sur l'impact de l'IA sur la validité de l'évaluation</li>
      <li><strong>Meilleures pratiques pour l'évaluation en RV :</strong> Comment concevoir et mettre en œuvre des évaluations dans des environnements immersifs</li>
      <li><strong>Discussion ouverte :</strong> Partagez vos expériences et défis avec d'autres éducateurs</li>
    </ul>

    <h2>Pourquoi l'évaluation axée sur le processus change tout</h2>
    <p>
    ...
    <h2>La recherche derrière l'évaluation axée sur le processus</h2>
    <p>
      Ce n'est pas qu'une théorie. Un article récent dans Frontiers in Education (<a href="https://doi.org/10.3389/feduc.2024.1499495" target="_blank" rel="noopener noreferrer">Alkouk & Khlaif, 2024</a>) a exploré les évaluations résistantes à l'IA dans l'enseignement supérieur. L'idée clé : lorsque vous suivez les actions des étudiants plutôt que les résultats finaux, vous créez une évaluation naturellement robuste contre l'assistance de l'IA.
    </p>
    <p>
    ...
    <h2>Rendre l'IA non pertinente, pas invisible</h2>
    <p>
    ...
    <ul>
      <li><strong>Notation de la technique :</strong> Comment l'IA de WhimsyLabs évalue la technique pratique en temps réel</li>
      <li><strong>Suivi des compétences :</strong> Mesurer l'amélioration sur plusieurs tentatives, pas seulement la performance finale</li>
      <li><strong>Analyse des erreurs :</strong> Comprendre où les étudiants rencontrent des difficultés et pourquoi</li>
      <li><strong>Tableaux de bord enseignants :</strong> Donner aux éducateurs une visibilité sur le développement des compétences pratiques</li>
    </ul>
    <p>
    ...
    <figure className="blog-image">
      <img
        ...
        alt="Replay 3D des actions de l'étudiant dans le laboratoire virtuel pour l'audit d'évaluation"
        style={{ width: '100%', maxWidth: '700px', margin: '0 auto 1.5rem', display: 'block', borderRadius: '8px' }}
      />
      <figcaption style={{ textAlign: 'center', fontStyle: 'italic', color: '#666', marginBottom: '1.5rem' }}>
        Les enseignants peuvent rejouer les actions des étudiants en 3D pour vérifier la technique pratique et auditer les évaluations.
      </figcaption>
    </figure>
    ...
    <ul>
      <li>Préoccupés par l'impact de l'IA sur la validité de l'évaluation</li>
      <li>Curieux de la technologie immersive dans l'éducation</li>
      <li>À la recherche d'approches pratiques pour une évaluation authentique</li>
      <li>Enseignants en sciences à tous les niveaux</li>
      <li>Impliqués dans la conception des programmes ou la politique d'évaluation</li>
    </ul>
    <p>
