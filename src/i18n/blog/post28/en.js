...
export const keywords = "virtual biology lab, virtual dissection, online biology experiments, microscopy simulation, biology practical, virtual anatomy";
export const content = null; // Uses main component content
