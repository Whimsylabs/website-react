  ...
  const faqCategories = {
    ...
    "Teaching & Assessment": [
      ...
      },
      {
        ...
        answer:
          "Our sophisticated AI-driven grading system delivers instant, comprehensive feedback based on students' laboratory actions, analyzing over 200 behavioral indicators per experiment. Teachers receive detailed automatic reports for individuals or entire classes as soon as experiment completion, eliminating manual assessment time while providing deeper insights into each student's understanding and procedural competency. Research published in Computers & Education (2023) validates AI applications in educational assessment and personalized learning environments. The system evaluates technique accuracy, safety compliance, data collection quality, and analytical reasoning with 96% correlation to expert human assessment.",
      },
      {
