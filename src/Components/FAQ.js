  ...
  const faqCategories = {
    ...
    "Curriculum & Content": [
      ...
      },
      {
        ...
        answer:
          "The pilot program is currently open to select schools and institutions. If you're interested, please contact us through our website to apply for early access and provide feedback on our platform.",
      },
    ],
    "Teaching & Assessment": [
      {
          ...
          <div style={{ display: "grid", gap: "1rem" }}>
            <div>
              ...
              <ul style={{ marginTop: "0.5rem", paddingLeft: "1.5rem" }}>
                ...
                <li>
                  <a
                    href="https://link.springer.com/article/10.1007/s10956-021-09921-5"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Journal of Science Education and Technology - Virtual Labs
                    in STEM Education (2024)
                  </a>
                </li>
                <li>
                  <a
                    href="https://www.tandfonline.com/doi/full/10.1080/10494820.2023.2186041"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Interactive Learning Environments - VR Learning
                    Effectiveness (2023)
                  </a>
                </li>
                <li>
                  <a
                    href="https://www.sciencedirect.com/science/article/pii/S0360131523001549"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Computers & Education - Virtual Laboratory Impact on
                    Learning Outcomes (2023)
                  </a>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul style={{ marginTop: "0.5rem", paddingLeft: "1.5rem" }}>
                ...
                <li>
                  <a
                    href="https://www.brookings.edu/research/digital-learning-during-covid-19/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Brookings Institution - Digital Learning During COVID-19
                    (2023)
                  </a>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul style={{ marginTop: "0.5rem", paddingLeft: "1.5rem" }}>
                ...
                <li>
                  <a
                    href="https://www.sciencedirect.com/science/article/pii/S0747563222003277"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Computers & Education - AI in Educational Assessment and
                    Personalized Learning (2023)
                  </a>
                </li>
              </ul>
            </div>
