...
const SchemaMarkup = () => {
  ...
  const organizationSchema = {
    ...
    description:
      "WhimsyLabs provides award-winning virtual laboratory software for science education, used in schools, colleges, and universities worldwide.",
    sameAs: [
  ...
  const productSchema = {
    ...
    description:
      "A sandbox virtual laboratory simulation that gives you the freedom to explore, play and learn scientific concepts firsthand. Accurately models biological, chemical, and physical reactions and processes.",
    aggregateRating: {
  ...
  const getBlogPostSchema = (slug) => {
    ...
    return {
      ...
      description:
        "A blog post about virtual laboratory technology and STEM education.",
    };
  };
  ...
  const courseSchema = {
    ...
    description:
      "Master laboratory skills in WhimsyLabs' advanced virtual environment. This comprehensive course covers fundamental to expert-level lab techniques across Biology, Chemistry, and Physics.",
    provider: {
      "@type": "Organization",
      name: "WhimsyLabs",
      sameAs: baseUrl,
  ...
  if (currentPath === "/") {
    ...
    if (currentPath !== "/blog") {
      ...
      schemasToInclude.push(
        getBlogPostSchema(currentPath.replace("/blog/", ""))
      );
    }
  }
