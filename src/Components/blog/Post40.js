...
export const title = "94% of Students Use AI for Assessed Work. Here's Why That's Not the Problem.";
export const date = "2026-06-01";
export const slug = "student-ai-use-assessment-crisis-solution";
export const description =
  "The HEPI 2026 survey shows near-universal AI use among UK students. The real crisis is not AI use itself, but that we are still assessing outputs that AI can easily produce. Process-based assessment offers a solution.";
...
export const content = (
  <div>
    <p>
      The Higher Education Policy Institute's 2026 Student Generative AI Survey landed last week with a statistic that made headlines: 94% of UK undergraduates now use generative AI to help with assessed work (
      <a
      ...
      ). The reaction was predictable. Some commentators wrung their hands about academic integrity. Others called for stricter detection tools. A few suggested we simply accept defeat and let AI write everything.
    </p>
    ...
    <h2>What Does the HEPI Survey Actually Show?</h2>
    ...
    <h2>Why Detection Cannot Solve This Problem</h2>
    ...
    <p>
      Independent analyses have found that AI detection tools produce false positive rates between 5% and 20%, meaning genuine student work is routinely flagged as machine-generated (
      <a
    ...
    <h2>The Real Problem: Assessing Outputs That No Longer Require Human Thinking</h2>
    ...
    <h2>What Does AI-Proof Assessment Look Like?</h2>

    <p>
      The OECD Digital Education Outlook 2026 answered this question explicitly: "Instead of grading the final paper, teachers should evaluate how a student interacted with AI, how they critiqued its output, and how they refined their ideas over time" (
      <a
      ...
      ). This is process-oriented assessment: evaluating not what students produce, but how they engage with learning to produce it.
    </p>
    ...
    <h2>How Virtual Labs Make Process Assessment Possible</h2>
    ...
    <h2>The Assessment Crisis Is Also an Opportunity</h2>
    ...
    <h2>What This Means for Science Education</h2>
    ...
    <>
      ...
      <ul>
        <li>
          <a href="/blog/oecd-process-oriented-assessment-validation">
