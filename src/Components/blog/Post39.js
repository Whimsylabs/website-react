...
export const title = "OECD Says Grade the Process, Not the Product: What This Means for Science Education";
export const date = "2026-05-19";
export const slug = "oecd-process-oriented-assessment-validation";
export const description =
  "The OECD Digital Education Outlook 2026 officially recommends 'process-oriented assessment' for the AI age. This international validation confirms what WhimsyLabs has built from the start.";
