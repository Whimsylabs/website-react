...
export const content = (
  <div>
    ...
    <p>
      ...
      transfer to real-world performance when the virtual environment maintains
      high levels of physical fidelity (
      <a
    ...
    <p>
      The ability to physically perform lab procedures in a virtual space not
      only enhances technical proficiency but also fosters deeper conceptual
      understanding. In traditional educational settings, students often
      struggle with abstract concepts because they lack the opportunity to see
      them in action. With Whimsylabs, concepts like fluid dynamics, chemical
      reactions, and instrument handling become intuitive, as students engage
      directly with the materials in a controlled yet realistic environment.
      Research in embodied cognition theory supports this approach, showing that
      physical interaction with learning materials significantly improves
      conceptual understanding and retention (
      <a
        href="https://www.sciencedirect.com/science/article/pii/S1041608010001184"
        target="_blank"
        rel="noopener noreferrer"
      >
        Barsalou, 2008
      </a>
      ). This hands-on approach ensures that learning is both engaging and
      effective, moving beyond passive instruction to active discovery.
    </p>
    <img
    ...
    />
    <p className="caption">
      Whimsylabs' immersive simulation technology allows for precise, 360-degree
      interactions with lab equipment, as demonstrated by the realistic handling
      of this beaker. This innovative approach bridges the gap between virtual
      training and real-world laboratory familiarity, fostering muscle memory
    ...
    <p>
      ...
      pre-scripted animations, our platform fully simulates fluid dynamics,
      allowing students to accurately practice techniques such as pipetting,
      titration, and handling volatile chemicals. Computational fluid dynamics
      (CFD) in educational contexts has been shown to provide students with
      unprecedented insights into complex flow phenomena that are otherwise
      difficult to visualize (
      <a
        href="https://pubmed.ncbi.nlm.nih.gov/21949524/"
        target="_blank"
        rel="noopener noreferrer"
      >
        Gavi et al., 2020
    ...
    <p>
      ...
      assesses performance across multiple parameters. Instead of a simple
      pass/fail model, our software evaluates a wide range of approaches and
      assigns scores accordingly, allowing students to explore different methods
      and see how their decisions impact results. Educational assessment
      research emphasizes the importance of formative feedback and
      multi-dimensional evaluation in promoting deep learning and scientific
      reasoning skills (
      <a
    ...
    <p>
      This sandbox-style grading means that in a single classroom, students can
      arrive at diverse solutions based on their individual approaches. Rather
      than enforcing a rigid step-by-step guide, we allow creativity and
      experimentation, mirroring how science is conducted in the real world.
    ...
    <p>
      ...
      <a
        href="https://www.sciencedirect.com/science/article/pii/S0360131517302543"
        target="_blank"
        rel="noopener noreferrer"
      >
        McGaghie et al., 2010
      </a>
      ). By allowing students to make mistakes and experience consequences in a
      safe virtual environment, we bridge the gap between academic training and
      professional readiness. This hands-on learning approach ensures that
      students entering higher education or the workforce are already
      comfortable with lab procedures, making them more competent and confident
      practitioners.{" "}
    </p>
    <p>
    ...
    <div className="references-section">
      ...
      <ul className="references-list">
        <li key="ref-1">
          ...
          <em>Annual Review of Psychology</em>, 59, 617-645.
        </li>
        <li key="ref-2">
        ...
        <li key="ref-6">
          ...
          research: 2003–2009. <em>Medical Education</em>, 44(1), 50-63.
        </li>
        <li key="ref-7">
