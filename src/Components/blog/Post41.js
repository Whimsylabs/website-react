...
export const title = "What the 2026 SEND White Paper Means for Science Teaching";
export const date = "2026-06-15";
export const slug = "send-white-paper-2026-science-practicals";
export const description =
  "The 2026 SEND White Paper gives every pupil with SEND a statutory Individual Support Plan and makes inclusion an Ofsted focus from September. Here is what it means for science teaching.";
...
export const content = (
  <div>
    <p>
      In February 2026, the government published its schools White Paper, <em>Every Child Achieving and Thriving</em>, setting out the most significant reform to special educational needs provision in more than a decade (
      <a
        href="https://www.gov.uk/government/publications/every-child-achieving-and-thriving"
        target="_blank"
        rel="noopener noreferrer"
      >
        DfE, 2026
      </a>
      ). At its centre is a simple but far-reaching commitment: every child with identified SEND in a mainstream school should have a statutory Individual Support Plan, and Education, Health and Care Plans should be reserved for those with the most complex needs.
    </p>
    ...
    <h2>Why Is Practical Science So Hard to Make Inclusive?</h2>
    ...
    <p>
      ...
      ). When demonstrations replace doing, the pupils who lose the most are those who were already least able to take part. A reform that promises genuine access to every pupil runs directly against this trend.
    </p>

    <h2>What Does an Individual Support Plan Have to Show?</h2>
    ...
    <p>
      ...
      ). A science department that cannot demonstrate how its SEND pupils access and progress in practical work will find it hard to evidence inclusion in one of the subjects that matters most to inspectors and families alike.
    </p>

    <h2>How Accessible Virtual Labs Give Every Pupil a Place at the Bench</h2>
    ...
    <h2>Turning the Evidence Burden Into a Documented Win</h2>
    ...
    <h2>What Science Departments Can Do Before September</h2>
      ...
      <ul>
        <li>
          <a href="/blog/virtual-kidney-dissection-send-engagement">
            Virtual Kidney Dissection: How Virtual Labs Boost SEND Engagement
          </a>
        </li>
        <li>
          <a href="/blog/premium-science-education-accessible-grants">
            Making Premium Science Education Accessible Through Grants
          </a>
        </li>
        <li>
          <a href="/blog/virtual-biology-lab-dissections-microscopy">
            The Virtual Biology Lab: Dissections and Microscopy Without the Barriers
          </a>
        </li>
        <li>
    ...
    <div className="references-section">
      ...
      <ul className="references-list">
        <li key="ref-1">
          Department for Education. (2026). Every Child Achieving and Thriving (Schools White Paper). GOV.UK.{" "}
          <a href="https://www.gov.uk/government/publications/every-child-achieving-and-thriving" target="_blank" rel="noopener noreferrer">
            https://www.gov.uk/government/publications/every-child-achieving-and-thriving
          </a>
        </li>
        <li key="ref-2">
          House of Commons Library. (2026). The Schools White Paper 2026: SEND Reform.{" "}
          <a href="https://commonslibrary.parliament.uk/research-briefings/cbp-10550/" target="_blank" rel="noopener noreferrer">
            https://commonslibrary.parliament.uk/research-briefings/cbp-10550/
          </a>
        </li>
        <li key="ref-3">
        ...
        <li key="ref-4">
          Royal Society &amp; EngineeringUK. (2024). Science Education Tracker 2023.{" "}
