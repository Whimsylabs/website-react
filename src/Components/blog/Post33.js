...
export const slug = "edtech-critics-right-passive-learning-vs-active-labs";
export const description =
  "US schools spent $30 billion on edtech in 2024. Critics say it's wasted. They're right—about passive screen time. Virtual labs that require active experimentation are fundamentally different.";
...
const RelatedArticles = () => {
  ...
  return (
    <>
      ...
      <ul>
        <li>
          <a href={getLocalizedPath("/blog/oecd-ai-learning-paradox-virtual-labs", language)}>
        ...
        <li>
          <a href={getLocalizedPath("/blog/pearson-webinar-vr-assessment-ai-age", language)}>
