...
export const content = (
  <div>
    <p>
      ...
      ). Traditional classrooms struggle to identify struggling students quickly enough to intervene before frustration becomes disengagement. WhimsyCat, WhimsyLabs' advanced AI tutor, pioneers a revolutionary approach: detecting frustration in real-time through multi-modal analysis of player actions, gaze patterns, and engagement behaviors, then providing immediate, empathetic support that prevents learning breakdowns before they occur. One example of this is students shaking virtual beakers in frustration when experiments go wrong: by looking at the vector of the beaker you can infer if it was an accident, or an expression of frustration.
    </p>
    ...
    <p>
      ...
      ). We deal with this interplay by directing users to more appropriate tools for their actions when misused repeatedly, prompting students about information they may have overlooked in the lab guide, and helping with practical technique. This allows students to make mistakes, and have that error in their data, while avoiding the "telling the student what to do" pitfall that reduces learning, retention and engagement.
    </p>
